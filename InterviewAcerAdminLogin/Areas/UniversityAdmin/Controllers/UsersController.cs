using InterviewAcerAdminLogin.Areas.UniversityAdmin.CustomActionFilter;
...
namespace InterviewAcerAdminLogin.Areas.UniversityAdmin.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<ActionResult> GetUserInformation(string userId)
        {
            ...
            return PartialView("~/Areas/UniversityAdmin/Views/Users/UserSpecificDetails.cshtml", userDetails);
        }
